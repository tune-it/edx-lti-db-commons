...
public class Lab1Data {
    ...
    static String[] getQueryTask5() {
        String queryVariant0 = "Выведите содержимое всех полей из таблицы аэропортов, которые удовлетворяют условию: название города должно быть равно \"Сыктывкар\".";
        return new String[]{queryVariant0};
    }
    ...
    static String[] getQueryTask9() {
        String queryVariant0 = "Выведите содержимое полей: тарифы, номера билетов из таблицы состоявшихся полетов. Отсортируйте результат по столбцу идентификаторы рейсов в порядке убывания. Вывести первые 3 строки.";
        return new String[]{queryVariant0};
    }
