...
public class Lab1Data {
    ...
    static String[] getQueryTask8() {
        String queryVariant0 = "Выведите самый дешёвый билет (все поля таблицы), соответствующий следующему условию: идентификатор рейса должен быть равен \"25223\".";
        return new String[]{queryVariant0};
    }
    ...
    static String[] getQueryTask10() {
        String queryVariant0 = "Подсчитайте планируемое время каждого полёта для всех воздушных судов (в минутах). Важно: в postgresql результат вычитания двух дат имеет тип interval. Для перевода значения типа interval в минуты, можно воспользоваться функцией extract.";
        return new String[]{queryVariant0};
    }
