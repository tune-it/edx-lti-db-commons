...
public class Lab2Data {
    ...
    static String[] getQueryTask2() {
        return new String[]{"Выведите содержимое полей времена планируемых прибытий, аэропорты прибытия, статусы из таблицы рейсов воздушного судна, заменив значения статусов 'Arrived' на 'Прибыл', а остальные на 'Не прибыл'."};
    }
    ...
    static String[] getQueryTask5() {
        return new String[]{"Выведите самый дорогой билет, соответствующий следующему условию: " +
